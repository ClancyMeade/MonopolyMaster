		...
		public static void greetPlayers()
			{
				...
				MonopolyRunner.players
						.add(new Player(playerOneName, 1500, 0, playerOneProperties, false, false, false, 0, 0));
				System.out.println();
				...
				MonopolyRunner.players
						.add(new Player(playerTwoName, 1500, 0, playerTwoProperties, false, false, false, 0, 0));
				System.out.println();
				System.out.println(
						"--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
